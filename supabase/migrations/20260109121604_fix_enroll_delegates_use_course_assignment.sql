/*
  # Fix delegate enrollment to use course assignments

  1. Changes
    - Updates trigger to only enroll delegates in courses they're assigned to
    - Uses booking_form_delegate_courses junction table
    - Matches booking's course run to the correct booking_form_course

  2. Logic
    - When booking created, find the matching booking_form_course by course name
    - Only enroll delegates assigned to that specific course
*/
